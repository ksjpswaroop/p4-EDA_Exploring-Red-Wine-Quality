Exploring Red Wine Quality by Swaroop Kallakuri
========================================================
...
2) Sulphates and
3) Acidity.  
  It is important to note, however, that wine quality is ultimately a subjective measure, although measured by wine experts.  That said, the correlations for these variables are within reasonable bounds.  The graphs adequately illustrate the factors that make good wines 'good' and bad wines 'bad'.  Further study with inferential statistics could be done to quantitatively confirm these assertions.
